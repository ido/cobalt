...
test_argslist = [
    { "tc_name" : "all_options_1", "args" : """-v -A myproj --attrs=a=1:b=2 --cwd /tmp -d --debuglog=/tmp/d --dependencies=1:2:3 -e /tmp/e --env v1=1:v2=2 --geometry 198x198x198x198 -h -i /bin/ls -M myemal@gmail.com -n10 -o /tmp/o -O /tmp --proccount 10 -qqueue --run_users user1:user2:user3 --run_project -t 10 --mode smp --kernel kernel -K kopts /bin/ls""", },
    { "tc_name" : "misc_1", "args" : """--mode c1 -n 512 --env BG_COREDUMPDISABLED=1 --proccount 512 -t 30 -q testing /bin/ls""", },
    ...
    { "tc_name" : "invalid_geometry_2", "args" : """--mode smp -t50 -n10 --geometry 1x2x3x4 /bin/ls""", },
    { "tc_name" : "invalid_geometry_3", "args" : """--mode smp -t50 -n10 --geometry 1x2x3x4 /bin/ls""", },
    { "tc_name" : "invalid_geometry_4", "args" : """--mode smp -t50 -n10 --geometry 48x48x48x48x2  /bin/ls""", },
    { "tc_name" : "invalid_geometry_5", "args" : """--mode smp -t50 -n10 --geometry 48x48x48x48x3  /bin/ls""", },
    { "tc_name" : "invalid_geometry_6", "args" : """--mode smp -t50 -n10 --geometry 128x64x32x4    /bin/ls""", },
    ...
    { "tc_name" : "mode_option_1", "args" : """-t10 -n512 --proccount 1023 --mode dual /bin/ls""", },
    ...
    { "tc_name" : "preboot_option", "args" : """--disable_preboot -t10 -n512 --proccount 1023 --mode dual /bin/ls""", },
    ]
