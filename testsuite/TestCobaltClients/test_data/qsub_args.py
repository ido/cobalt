...
test_argslist = [
    ...
    { "tc_name" : "env_option_4", "args" : """--env var1=val1 --env "var2=svar1\=sval1\:svar2\=sval2" --env var3=val3 -t50 -n10 /bin/ls""", 'old_args' : """--env "var1=val1:var2=svar1\=sval1\:svar2\=sval2:var3=val3" -t50 -n10 /bin/ls""", },
    { "tc_name" : "script_1", "args" : """cobalt_script1.sh""", 'old_args' : """--env a=1:c=3:b=2 -t75 -n100 --mode script cobalt_script1.sh""", },
