...
test_argslist = [
    { "tc_name" : "all_options_1", "args" : """-v -A myproj --attrs=a=1:b=2 --cwd /tmp -d --debuglog=/tmp/d --dependencies=1:2:3 -e /tmp/e --env v1=1:v2=2 --geometry 198x198x198x198 -h -i /bin/ls -M myemal@gmail.com -n10 -o /tmp/o -O /tmp --proccount 10 -qqueue --run_users user1:user2:user3 --run_project -t 10 --mode smp --kernel kernel -K kopts /bin/ls""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "misc_1", "args" : """--mode c1 -n 512 --env BG_COREDUMPDISABLED=1 --proccount 512 -t 30 -q testing /bin/ls""", 'skip_list' : ['not_bsim'], },
    ...
    { "tc_name" : "invalid_geometry_6", "args" : """--mode smp -t50 -n10 --geometry 128x64x32x4    /bin/ls""", 'skip_list' : ['not_bsim'], },
