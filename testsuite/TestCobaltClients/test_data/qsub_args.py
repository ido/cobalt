...
test_argslist = [
    ...
    { "tc_name" : "invalid_geometry_2", "args" : """--mode script -t50 -n10 --geometry 1x2x3x4 /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    { "tc_name" : "invalid_geometry_3", "args" : """--mode script -t50 -n10 --geometry 1x2x3x4 /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    { "tc_name" : "invalid_geometry_4", "args" : """--mode script -t50 -n10 --geometry 48x48x48x48x2  /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    { "tc_name" : "invalid_geometry_5", "args" : """--mode script -t50 -n10 --geometry 48x48x48x48x3  /bin/ls""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "invalid_geometry_6", "args" : """--mode script -t50 -n10 --geometry 128x64x32x4    /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    { "tc_name" : "no_project_specified", "args" : """-A -t50 -n10 /bin/ls""", },
    ...
    { "tc_name" : "mode_option_1", "args" : """-t10 -n512 --proccount 1023 --mode vn /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    { "tc_name" : "mode_option_2", "args" : """-t10 -n512 --proccount 1023 --mode vn /bin/ls""", 'new_only':True},
    { "tc_name" : "mode_option_3", "args" : """--mode script -t50 -n10 --geometry 40x40x50x50 /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    { "tc_name" : "mode_option_4", "args" : """-A Acceptance -q testing -n 49152 -t 60 --mode script /bin/ls""", },
    { "tc_name" : "preboot_option", "args" : """--disable_preboot -t10 -n512 --proccount 1023 --mode vn /bin/ls""", 'skip_list' : ['not_bsim'], 'new_only':True},
    ...
    { "tc_name" : "env_option_4", "args" : """--env var1=val1 --env "var2=svar1\=sval1\:svar2\=sval2" --env var3=val3 -t50 -n10 /bin/ls""", 'new_only':True},
    { "tc_name" : "script_1", "args" : """cobalt_script1.sh""", 'new_only':True},
    { "tc_name" : "script_2", "args" : """-t 50 cobalt_script1.sh""", 'new_only':True},
    ...
    { "tc_name" : "interactive_5", "args" : """-I -t50 -n 1""", "testhook" : "JOB_RUNNING", 'new_only':True},
    { "tc_name" : "interactive_6", "args" : """--interactive -t50 -n 1""", "testhook" : "JOB_RUNNING", 'new_only':True},
    { "tc_name" : "interactive_7", "args" : """--mode interactive -t50 -n 1""", "testhook" : "JOB_RUNNING", 'new_only':True},
    ]
