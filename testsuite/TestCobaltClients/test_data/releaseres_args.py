...
test_argslist = [
    ...
    { "tc_name" : "arg_3", "args" : """s1 s2 s3""", "new_only" : True, },
    { "tc_name" : "arg_4", "args" : """s1 s2 s3 s4""", "new_only" : True, },
    { "tc_name" : "arg_5", "args" : """-p p1 s1 s2 s3""", "new_only" : True},
    { "tc_name" : "arg_6", "args" : """-t p1 s1 s2 s3""", },
    { "tc_name" : "arg_7", "args" : """-d p1 s1 s2 s3""", "new_only" : True, },
    { "tc_name" : "arg_8", "args" : """--debug p1 s1 s2 s3""", "new_only" : True, },
