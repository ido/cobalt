...
test_argslist = [
    ...
    { "tc_name" : "force_3", "args" : """--force_id -p ANL-R00-R01-2048 -s 2013_03_09-10:30""", 'new_only' : True, },
    ...
    { "tc_name" : "modify_5", "args" : """-m -n resname -D -s 2013_03_9-10:10""", 'new_only' : True, },
    { "tc_name" : "modify_6", "args" : """-m -n resname -D -d 10:10:10""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    { "tc_name" : "modify_7", "args" : """-m -n resname -s 2013_03_9-10:10 -c 10:30:30 -d 00:01:00""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    { "tc_name" : "modify_8", "args" : """-m -n resname -s 2013_03_9-10:10 -c 10 -d 50 -u user1""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    { "tc_name" : "modify_9", "args" : """-m -n resname -s 2013_03_9-10:10 -c 10 -d 50 -u user1:user2""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    { "tc_name" : "modify_10", "args" : """-m -n resname -s 2013_03_9-10:10 -c 10 -d 50 -A myproj -u user1""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    { "tc_name" : "modify_11", "args" : """-m -n resname -s 2013_03_9-10:10 -c 10 -d 50 -A myproj --block_passthrough""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    { "tc_name" : "modify_12", "args" : """-m -n resname -s 2013_03_9-10:10 -c 10 -d 50 -A myproj --allow_passthrough""", 'skip_list' : ['not_bsim'], 'new_only': True, },
    ...
    { "tc_name" : "add_res_3", "args" : """-n resname -s 2013_03_9-10:10 ANL-R00-R01-2048 ANL-R00-1024""", "new_only" : True, },
    ...
    { "tc_name" : "add_res_6", "args" : """-s 2013_03_9-10:10 -n resname -d 50 -c 10:10:10 ANL-R00-R01-2048 ANL-R00-1024""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_7", "args" : """-s 2013_03_9-10:10 -n resname -d 10:10:10 -p ANL-R00-R01-2048 --block_passthrough""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_8", "args" : """-s 2013_03_9-10:10 -n resname -d 10:10:10 -p ANL-R00-R01-2048 --block_passthrough -q myq -A myproj""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_9", "args" : """-s 2013_03_9-10:10 -n resname -d 10:10:10 -p ANL-R00-R01-2048 --block_passthrough -q myq -A myproj --debug""",  'new_only': True, 'skip_list' : ['not_bsim'], },
