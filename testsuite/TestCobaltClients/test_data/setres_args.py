...
test_argslist = [
    ...
    { "tc_name" : "modify_14", "args" : """-m -n resname -A myproj --block_passthrough p1 p2 p3""", 'skip_list' : ['not_bsim'], },
    ...
    { "tc_name" : "add_res_4", "args" : """-n resname -s 2013_03_9-10:10 -d 50 p1 p2""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_5", "args" : """-n resname -s 2013_03_9-10:10 -d 50 -c 10:10:10 p1 p2""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_6", "args" : """-s 2013_03_9-10:10 -d 50 -c 10:10:10 p1 p2""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_7", "args" : """-s 2013_03_9-10:10 -d 10:10:10 -p p1 --block_passthrough""", 'skip_list' : ['not_bsim'], },
    { "tc_name" : "add_res_8", "args" : """-s 2013_03_9-10:10 -d 10:10:10 -p p1 --block_passthrough -q myq -A myproj""", 'skip_list' : ['not_bsim'], },
    ]
