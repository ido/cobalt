...
test_argslist = [
    ...
    { "tc_name" : "combo_1", "args" : """--up --down p1""", },
    { "tc_name" : "combo_2", "args" : """--up -l p1""", "new_only" : True,},
    { "tc_name" : "combo_3", "args" : """--list --queue q1 p1""", "new_only" : True,},
    { "tc_name" : "combo_4", "args" : """--up --queue q1 p1""", "new_only" : True,},
    { "tc_name" : "combo_5", "args" : """--down --list p1""", "new_only" : True,},
