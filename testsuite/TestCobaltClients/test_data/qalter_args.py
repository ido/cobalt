...
test_argslist = [
    ...
    { "tc_name" : "user_1", "args" : """-v --run_users user1:user2:user3 1 2 3 4 5""", 'skip_list' : ['not_bsim'], },
    ...
    { "tc_name" : "geometry_4", "args" : """-v --geometry 10x10x10x10x1  1 2 3 4 5""", 'skip_list' : ['not_bsim'], },
