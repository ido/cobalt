...
INSERT INTO RESERVATION_EVENTS (NAME) VALUES( 'creating')
INSERT INTO RESERVATION_EVENTS (NAME) VALUES( 'activating')
INSERT INTO RESERVATION_EVENTS (NAME) VALUES( 'ending')
INSERT INTO RESERVATION_EVENTS (NAME) VALUES( 'cycling')
INSERT INTO RESERVATION_EVENTS (NAME) VALUES( 'modifying')


CREATE TABLE RESERVATION_PROG ( \
   ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1, CACHE 10 ORDER) NOT NULL PRIMARY KEY, \
   RES_DATA_ID INTEGER NOT NULL REFERENCES RESERVATION_DATA("ID"), \
   EVENT_TYPE INTEGER NOT NULL REFERENCES RESERVATION_EVENTS("ID"), \
