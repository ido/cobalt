...
python2.7 setup.py install --prefix=${RPM_BUILD_ROOT}%{client_wrapper_dir} --install-lib ${RPM_BUILD_ROOT}/usr/lib64/python2.7/site-packages
...
/usr/lib*/python2.7/site-packages/Cobalt/*
/usr/lib*/python2.7/site-packages/Cobalt-*egg-info*
